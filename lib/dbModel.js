...
module.exports = db => {
  ...
  let pollSchema = new mongoose.Schema({
    ...
    options: {type: ['String'], default: []}, // list of `votedFor` possibilities
  ...
  let voteSchema = new mongoose.Schema({
    ...
    valid: {type: 'Boolean', default: true} // for locking somebody from voting.
  })
  voteSchema.index({pollId: 1, doneBy: 1}, {unique: true})
